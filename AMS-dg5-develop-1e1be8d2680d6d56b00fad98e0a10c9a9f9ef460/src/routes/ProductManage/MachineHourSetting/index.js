...
class MachineHourSetting extends React.Component {
  constructor(props) {
    super(props);
      ...
      <Page>
        ...
        <div className="row">
          <div className="ModalButton">
            <Modal
              name="MachineHourSettingAddModal"
              title="新增机器工时"
              btnName="新增"
              // shouldModalShow={this.shouldModalShowAdd}
              formName="MachineHourSettingAddForm"
            >
              <Form
                name="MachineHourSettingAddForm"
                action={actionPost}
              ...
              >
                <div className="row">
                  ...
                  <div className="col-4" />
                  <div className="col-10">
                    <Input name="workTimeA" floatingLabelText="机器工时-A" fullWidth />
                  </div>
                  <div className="col-4" />
                  <div className="col-10">
                    <Input name="workTimeB" floatingLabelText="机器工时-B" fullWidth />
                  </div>
                </div>
              </Form>
            </Modal>
          ...
          <div className="ModalButton">
            <Modal
              name="MachineHourSettingUpdateModal"
              title="修改机器工时"
              btnName="修改"
              shouldModalShow={this.shouldModalShowUpdate}
              formName="MachineHourSettingUpdateForm"
            >
              <Form
                name="MachineHourSettingUpdateForm"
                action={actionPut}
                method={this.state.method}
                dataTemplate={dialogDataTemplate}
                onClientSubmit={this.onSubmitModal}
              ...
              >
                <div className="row">
                  ...
                  <div className="col-4" />
                  <div className="col-10">
                    <Input name="workTimeA" floatingLabelText="机器工时-A" value={this.state.workTimeA} fullWidth />
                  </div>
                  <div className="col-4" />
                  <div className="col-10">
                    <Input name="workTimeB" floatingLabelText="机器工时-B" value={this.state.workTimeB} fullWidth />
                  </div>
                </div>
              </Form>
            </Modal>
...
export default MachineHourSetting;
