...
class PCBSetting extends React.Component {
  constructor(props) {
    super(props);
      ...
      <Page>
        ...
        <div className="row">
          <div className="ModalButton">
            <Modal
              name="PCBSettingAddModal"
              title="新增PCB"
              btnName="新增"
              // shouldModalShow={this.shouldModalShowAdd}
              formName="PCBSettingAddForm"
            >
              <Form
                name="PCBSettingAddForm"
                action={actionPost}
              ...
              >
                <div className="row">
                  ...
                  <div className="col-4" />
                  <div className="col-10">
                    <Input name="materialNo" floatingLabelText="PCB料号" fullWidth />
                  </div>
                  <div className="col-4" />
                  <div className="col-10">
                    <Input name="length" floatingLabelText="长度" fullWidth />
                  </div>
                  <div className="col-4" />
                  <div className="col-10">
                    <Input name="width" floatingLabelText="宽度" fullWidth />
                  </div>
                  <div className="col-4" />
                  <div className="col-10">
                    <Input name="height" floatingLabelText="高度" fullWidth />
                  </div>
                </div>
              </Form>
            </Modal>
          ...
          <div className="ModalButton">
            <Modal
              name="PCBSettingUpdateModal"
              title="修改机器工时"
              btnName="修改"
              shouldModalShow={this.shouldModalShowUpdate}
              formName="PCBSettingUpdateForm"
            >
              <Form
                name="PCBSettingUpdateForm"
                action={actionPut}
                method={this.state.method}
                dataTemplate={dialogDataTemplate}
                onClientSubmit={this.onSubmitModal}
              ...
              >
                <div className="row">
                  ...
                  <div className="col-4" />
                  <div className="col-10">
                    <Input name="materialNo" floatingLabelText="料号" value={this.state.materialNo} fullWidth />
                  </div>
                  <div className="col-4" />
                  <div className="col-10">
                    <Input name="length" floatingLabelText="长度" value={this.state.length} fullWidth />
                  </div>
                  <div className="col-4" />
                  <div className="col-10">
                    <Input name="width" floatingLabelText="宽度" value={this.state.width} fullWidth />
                  </div>
                  <div className="col-4" />
                  <div className="col-10">
                    <Input name="height" floatingLabelText="高度" value={this.state.height} fullWidth />
                  </div>
                </div>
              </Form>
            </Modal>
