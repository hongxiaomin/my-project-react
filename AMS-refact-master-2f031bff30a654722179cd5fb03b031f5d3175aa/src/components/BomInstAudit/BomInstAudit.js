...
const BOMInstAuditAPI = `${SERVER_IP_BOM}/bom/instruction/summary`;
...
BOMInstAudit.defaultProps = {

};
BOMInstAudit.propTypes = {

};

export default BOMInstAudit;
