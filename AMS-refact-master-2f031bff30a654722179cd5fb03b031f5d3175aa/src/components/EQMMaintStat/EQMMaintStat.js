...
const EQMMaintStatApi = `${SERVER_IP_EQM}/ams/eqm/solution/statistics`;
...
const EQMMaintStat = props => (
  <div>
    <Bread breadMap={breadMap} />
    <Title name="维修统计" />
    <FormContainer
      name="EQMMaintStatForm"
      chartName="EQMMaintStatBarchart"
      action={EQMMaintStatApi}
      method="GET"
    ...
    <div>
      <BarChartContainer
        name="EQMMaintStatBarchart"
        containerWidth="50%"
        containerHeight="50%"
        dataSourceTemplate={dataSourceTemplate}
        aspect={1.4}
        xAxis={{
          dataKey: 'solutionItemName',
          label: '解决方案名称',
        }}
        yAxis={{
          dataKey: 'percent',
...
EQMMaintStat.defaultProps = {

};
EQMMaintStat.propTypes = {

};

export default EQMMaintStat;
