...
const EQMScrapStatApi = `${SERVER_IP_EQM}/ams/eqm/eqp/scrap/statistics`;
...
const EQMScrapStat = props => (
  <div>
    <Bread breadMap={breadMap} />
    <Title name="报废统计" />
    <FormContainer
      name="EQMScrapStatForm"
      chartName="EQMScrapStatchart"
      action={EQMScrapStatApi}
      method="GET"
    ...
    <div>
      <BarChartContainer
        name="EQMScrapStatchart"
        containerWidth="50%"
        containerHeight="50%"
        dataSourceTemplate={dataSourceTemplate}
        aspect={1.4}
        xAxis={{
          dataKey: 'scrapItemName',
          label: '统计名称',
        }}
        yAxis={{
          dataKey: 'percent',
...
EQMScrapStat.defaultProps = {

};
EQMScrapStat.propTypes = {

};

export default EQMScrapStat;
