...
const RuleGraph = (props) => {
  const { ruleData, graphData } = props;
  return (
    <div
    ...
    >
      <div
        onLoad={addVertexInit(addVertex, ruleData, document.getElementById('toobarName'), document.getElementById('toolbar'), true)}
...
RuleGraph.defaultProps = {

};
RuleGraph.propTypes = {
  ruleData: PropTypes.arrayOf(Object),
  routingData: PropTypes.arrayOf(Object),
  graphData: PropTypes.arrayOf(Object),
};
